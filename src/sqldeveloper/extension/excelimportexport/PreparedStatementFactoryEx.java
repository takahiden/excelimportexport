...
public class PreparedStatementFactoryEx extends PreparedStatementFactory {

	@Override
	public IPreparedBatchStatement createPreparedBatchStatement(String sql, IDatabaseConnection connection)
			throws SQLException {

		return new IPreparedBatchStatementEx(super.createPreparedBatchStatement(sql, connection));
	}
